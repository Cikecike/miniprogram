...
def Artic_Writer(conn=None,artic_args=None):
    ...
    if artic_args['cover_img_url']!='':
        sql1="INSERT INTO article(author,artic_title,artic_summary,cover_img_url)VALUES('%s','%s','%s','%s')"%(artic_args['author'],artic_args['artic_title'],artic_args['artic_summary'],artic_args['cover_img_url'])
    else:
        sql1 = "INSERT INTO article(author,artic_title,artic_summary)VALUES('%s','%s','%s')" % (artic_args['author'], artic_args['artic_title'], artic_args['artic_summary'])
